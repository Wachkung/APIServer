module.exports = {
            ...
            db2.getConnection((err, conn) => {
                if (err) {
                    ...
                    let sql = `
                            ...
                            vstdttm between '2016-10-01 00:00:00' and '2017-09-30 23:59:59' and cln='20100'
                            GROUP BY hn
                            ) as d2 
                            ...
                            and d1.cnt='1'
                            where 
                            o.vstdttm between '2016-10-01 00:00:00' and '2017-09-30 23:59:59' and o.cln='20100' and d1.icd10 = d2.icd10
            ...
            db2.getConnection((err, conn) => {
                if (err) {
                    ...
                    let sql = `
                            ...
                            AND DATE_FORMAT(ovst.vstdttm,'%Y-%m-%d') BETWEEN '2016-10-01' AND '2017-09-330'  AND ovst.ovstost= '4'
                            GROUP BY dct 
                            ...
                            WHERE dct.lcno !='' AND ovst.dct !='' AND ovst.dct IS NOT NULL AND (DATE_FORMAT(ovst.vstdttm,'%Y-%m-%d') BETWEEN '2016-10-01' AND '2017-09-330') AND ovst.ovstost= '4' 
                            GROUP BY dct 
                            ) AS aa
            ...
            db2.getConnection((err, conn) => {
                if (err) {
                    ...
                    let sql = `
                            ...
                            WHERE DATE_FORMAT(ovst.vstdttm,'%Y-%m-%d') BETWEEN '2016-10-01' and '2017-09-30' AND ovst.ovstost = '3' AND ovst.an = '0'
                            GROUP BY ovst.vn) as a 
                            INNER JOIN pttype on pttype.pttype = a.pttype
            ...
            db2.getConnection((err, conn) => {
                if (err) {
                    ...
                    let sql = `
                            ...
                            WHERE DATE_FORMAT(ovst.vstdttm,'%Y-%m-%d') BETWEEN '2016-10-01' and '2017-09-30' AND ipt.dchtype = '4' 
                            GROUP BY ovst.vn) as a 
                            INNER JOIN pttype on pttype.pttype = a.pttype
                            WHERE pttype.inscl = 'UCS' 
                            GROUP BY month ORDER BY a.vstdttm,count desc)d, (SELECT @rownum:=0) r
    ...
    typetotal(db2, startdate, enddate) {
        return new Promise((resolve, reject) => {
            db2.getConnection((err, conn) => {
                if (err) {
                    reject(err);
